...
VL_INLINE_OPT VlCoroutine Vtb___024root___eval_initial__TOP__Vtiming__1(Vtb___024root* vlSelf) {
    ...
    while (1U) {
        co_await vlSelf->__VdlySched.delay(0xaULL, 
                                           ...
                                           "tb.v", 
                                           20);
        vlSelf->__Vdlyvval__tb__DOT__rnd__v0 = (0xffU 
                                                & VL_RANDOM_SEEDED_II(vlSelf->tb__DOT__seed));
        vlSelf->__Vdlyvset__tb__DOT__rnd__v0 = 1U;
    }
}
...
VL_INLINE_OPT void Vtb___024root___nba_sequent__TOP__0(Vtb___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb__DOT__value = ((IData)(vlSelf->tb__DOT__rstn)
                               ? (0xffU & ((IData)(1U) 
                                           + (IData)(vlSelf->tb__DOT__value)))
                               : 0U);
}
...
VL_INLINE_OPT void Vtb___024root___nba_sequent__TOP__1(Vtb___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->__Vdlyvset__tb__DOT__rnd__v0) {
        vlSelf->tb__DOT__rnd = vlSelf->__Vdlyvval__tb__DOT__rnd__v0;
        vlSelf->__Vdlyvset__tb__DOT__rnd__v0 = 0U;
    }
